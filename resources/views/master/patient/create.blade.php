                ...
                <div class="text-xs md:text-sm space-y-3 max-w-xl mx-auto">
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            value="{{ old('name') }}" placeholder="Masukkan Nama Pasien" required>
                    </div>
                    <div class="flex flex-col gap-1">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="date" id="birth_date" name="birth_date"
                            class="text-xs md:text-sm rounded-lg border border-gray-300 shadow-md"
                            value="{{ old('birth_date') }}" placeholder="Masukkan Tanggal Lahir" required>
                    </div>
                    <div class="flex flex-col gap-1">
                        <label for="phone">Nomor Hp</label>
                        <input type="text" id="phone" name="phone"
                            class="text-xs md:text-sm rounded-lg border border-gray-300 shadow-md"
                            value="{{ old('phone') }}" placeholder="Contoh: 081234567890" maxlength="13"
