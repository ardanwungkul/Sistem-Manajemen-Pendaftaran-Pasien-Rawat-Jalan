                ...
                <div class="text-xs md:text-sm space-y-3 max-w-xl mx-auto">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <input type="date" id="visit_date" name="visit_date"
                            ...
                            value="{{ old('visit_date') }}" placeholder="Pilih Tanggal Kunjungan" required>
                    </div>

                    <div class="flex flex-col gap-1">
                        <label for="complaint">Keluhan</label>
                        <textarea name="complaint" id="complaint" rows="3" placeholder="Masukkan Keluhan"
                            class="text-xs md:text-sm rounded-lg border border-gray-300 shadow-md" required></textarea>
                    </div>
